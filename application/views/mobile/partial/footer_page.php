<div data-role="footer" data-theme="a" >
		...
		<div data-role="navbar" data-theme="e" class="pie">
            <ul>
                ...
                <li title="ubicación"><a href="#geo" data-transition="slideup" data-icon="search"  onclick="sessionStorage.categoria_id=<?php echo isset($oferta->id)?$oferta->id:0;?>;sessionStorage.lugar_id=<?php echo isset($lugar->id)?$lugar->id:0;?>">Ubicación</a></li>
            </ul>
        </div>

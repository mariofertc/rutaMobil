<div data-role="header" data-theme="a" class="yellow">
    ...
    <div data-role="navbar" data-theme="a" >
        <ul>
            <li><a href="javascript:history.go(-1)" class="twitter-follow-button" data-show-count="false" data-show-screen-name="false"><img src="<?php echo base_url();?>images/regresar.png" width="32" height="32" alt="Visit our Twitter Feed"><br />
                    REGRESAR</a>
                </a></li>

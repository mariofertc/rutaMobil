...
<div id="menubar">
	<div id="menubar_container">
		...
		<div id="menubar_navigation">
			...
			?>
			<div class="menu_item">
				<a href="<?php echo site_url("$module->nombre");?>">
				<img src="<?php echo base_url().'images/administracion/'.$module->nombre.'.png';?>" border="0" alt="Menubar Image" /></a><br />
				<a href="<?php echo site_url("$module->nombre");?>"><?php echo $this->lang->line("module_".$module->nombre) ?></a>
			</div>
			<?php
				}
			}
